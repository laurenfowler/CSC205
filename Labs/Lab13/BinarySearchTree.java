...
// the use of the constructors from BinaryTreeBasis
  ...
  {
	boolean duplicate=duplicateCheck(this.root, otherTree.getRoot());
	return duplicate;
  }

  private boolean duplicateCheck(TreeNode t1, TreeNode t2)
  {
//	KeyedItem node1= (KeyedItem) t1.getItem();
//	KeyedItem node2 = (KeyedItem) t2.getItem();
//	System.out.println("comparing " + node1 + " and " + node2);	
	if(t1==null && t2==null)
	{
		return true;
	}
	...
	else if(((KeyedItem)t1.getItem()).getKey() !=((KeyedItem) t2.getItem()).getKey())
	{
		return false;
	}
	else 	
